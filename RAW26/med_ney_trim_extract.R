...
library(dplyr)
setwd("C:/Users/01459189/OneDrive/phd/hpc/RAW26/med_ney_trim")

files <- list.files(
  "C:/Users/01459189/OneDrive/phd/hpc/RAW26/med_ney_trim",
  pattern = "med_ney_trim.*\\.Rdata$",
  full.names = TRUE
)

parse_settings <- function(name) {
  list(
    dataset = sub("^med_ney_trim(.*?)_results.*", "\\1", name),
...
base_out <- "C:/Users/01459189/OneDrive/phd/hpc/WIP26/med_ney_trim/"
...
save(res, file = paste0(base_out, "med_ney_trim_all_res.RData"))