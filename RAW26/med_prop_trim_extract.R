...
library(dplyr)
setwd("C:/Users/01459189/OneDrive/phd/hpc/RAW26/med_prop_trim")

files <- list.files(
  "C:/Users/01459189/OneDrive/phd/hpc/RAW26/med_prop_trim",
  pattern = "med_prop_trim.*\\.Rdata$",
  full.names = TRUE
)

parse_settings <- function(name) {
  list(
    dataset = sub("^med_prop_trim(.*?)_results.*", "\\1", name),
...
base_out <- "C:/Users/01459189/OneDrive/phd/hpc/WIP26/med_prop_trim/"
...
save(res, file = paste0(base_out, "med_prop_trim_all_res.RData"))