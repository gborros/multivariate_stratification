...
library(dplyr)
setwd("C:/Users/01459189/OneDrive/phd/hpc/RAW26/med_prop")

files <- list.files(
  "C:/Users/01459189/OneDrive/phd/hpc/RAW26/med_prop",
  pattern = "med_prop.*\\.Rdata$",
  full.names = TRUE
)

parse_settings <- function(name) {
  list(
    dataset = sub("^med_prop(.*?)_results.*", "\\1", name),
...
base_out <- "C:/Users/01459189/OneDrive/phd/hpc/WIP26/med_prop/"
...
save(res, file = paste0(base_out, "med_prop_all_res.RData"))